                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col text-start">
                                    ...
                                    <h6 id="text-card" class="text-white mt-3 mb-0">Jumlah Siswa Sudah Vote</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-3 position-relative">
                            <div class="row">
                                <div class="col text-start">
                                    ...
                                    <h6 id="text-card" class="text-white mt-3 mb-0">Total Siswa</h6>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-6 col-12 mt-4 mt-lg-0">
            <div class="card shadow h-100">
                <div class="card-header pb-0 p-3">
                    <h5 class="mb-0 text-center">Grafik Perolehan Suara Ketua OSIS</h5>
                </div>
    ...
    <div class="row my-4">
                            ...
                            <div class="col px-0">
                                <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                                    <div class="card calon-card ps-2">
                                        ...
                                        <div class="card-body justify-content-center" style="height: 200px; width: 250px;">
                                            <h5 class="card-title pb-2 fs-5 fw-bolder"><?= $data['Nama'] ?></h5>
                                            <!-- <p class="card-text fs-6"><?= $data[''] ?></p> -->
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="card h-100">
                <div class="card-header pb-0">
                    <h6>Alur Pemilihan Calon Ketua OSIS</h6>
                </div>
                    ...
                    <div class="timeline timeline-one-side">
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">22 Desember</p>
                            </div>
                        </div>
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">Pemilihan Calon Ketua OSIS</h6>
                        ...
                        <div class="timeline-block mb-3">
                            ...
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">Penetapan Calon Ketua OSIS</h6>
